...
Build a contact section of a marketing website to collect feedback from users! It has to be responsive and the layout adjusts well for all possible devices, be it laptop, tablet, mobile, or beyond.
...
- Aim to follow the design as closely as possible. All elements in the design should be present, using the same text color, font size, font weight, spacing, dimensions, etc.
- Text size should be responsive; font size is larger for wider devices, smaller for narrow devices.
- Telephone and Email are links that help you directly call the number / send an email.
- The form should have basic validation that the require fields are non-empty, the email address is valid.
- Upon successful submission, an alert should show up saying "Your message has been received".

### What you can learn

- **HTML structure**: You'll learn how to structure your HTML code to create the layout of the hero section. This includes understanding the use of HTML tags like `<div>`, `<h1>`, `<p>`, `<img>`, and potentially semantic HTML elements like `<header>` and `<section>`.
- **CSS styling**: You'll gain experience in styling your HTML elements using CSS. This involves setting properties such as colors, fonts, margins, padding, and positioning to achieve the desired visual appearance for your hero section.
- **Responsive design**: You'll learn about creating responsive designs that adapt to different screen sizes and devices. This involves using techniques like media queries and flexible layout techniques such as CSS Grid or Flexbox to ensure that your hero section looks good on desktops, tablets, and mobile devices.
- **Typography**: You'll understand how to choose and style fonts effectively to enhance the readability and visual appeal of your hero section. This includes selecting appropriate font sizes, weights, and line heights.
...
- `README.md`: This file.
- `designs`: Design image files for the challenge.
- `index.html`: Entrypoint for your website. You should be editing in this file.
- `css`: For writing any custom CSS styles.
- `js`: For writing any custom JavaScript to add interaction to the page.
...
🔥 Good luck on your journey of becoming a great Front End Developer! 🔥
